...
class AirQualityForecast(BaseModel):
    ...
    co2: Optional[confloat(ge=0.0)] = Field(
        None, description='Carbon Dioxide forecasted'
    )
    ...
    no2: Optional[confloat(ge=0.0)] = Field(
        None, description='Nitrogen dioxide forecasted'
    )
    nox: Optional[confloat(ge=0.0)] = Field(
        None, description='Other Nitrogen oxides forecasted'
    )
    o3: Optional[confloat(ge=0.0)] = Field(None, description='Ozone forecasted')
    owner: Optional[
        List[
            Union[
                constr(
    ...
    relativeHumidity: Optional[confloat(ge=0.0, le=1.0)] = Field(
        None, description='Humidity in the Air'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type: it has to be AirQualityForecast'
    )
