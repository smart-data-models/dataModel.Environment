...
class Type6(Enum):
    ElectroMagneticObserved = 'ElectroMagneticObserved'


class ElectroMagneticObserved(BaseModel):
    ...
    eMF: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='It has to be ElectroMagneticObserved'
    )
