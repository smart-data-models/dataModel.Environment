...
class TrafficEnvironmentImpactForecast(BaseModel):
    ...
    co2: Optional[float] = Field(
        None, description='The expected C02 emission concentration'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be TrafficEnvironmentImpactForecast'
    )
