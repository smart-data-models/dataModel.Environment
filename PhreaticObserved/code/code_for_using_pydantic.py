...
class Type6(Enum):
    PhreaticObserved = 'PhreaticObserved'


class PhreaticObserved(BaseModel):
    ...
    investigationDepth: Optional[float] = Field(
        None,
    ...
    isMobile: Optional[bool] = Field(
        None, description='The device used is Fixed (False) or Mobile (True)'
    )
    location: Optional[
    ...
    measurementType: Optional[List[MeasurementTypeEnum]] = Field(
        None,
    ...
    pollutionRate: Optional[float] = Field(
        None,
    ...
    ] = Field(None, description='Reference to the devices providing data')
    residueLevel: Optional[float] = Field(None, description='Residue level found')
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be PhreaticObserved'
    )
    waterTable: Optional[float] = Field(
        None,
