...
class Type6(Enum):
    WaterObserved = 'WaterObserved'


class WaterObserved(BaseModel):
    ...
    flow: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    height: Optional[confloat(ge=0.0)] = Field(
        None, description='Water height - Level reach on alert coasts'
    )
    id: Optional[
        Union[
            constr(
    ...
    objectArea: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    objectHeightAverage: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    objectHeightMax: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    objectVolume: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    swellDirection: Optional[confloat(ge=0.0, le=360.0)] = Field(
        None, description='Swells Direction observed'
    )
    swellHeight: Optional[confloat(ge=0.0)] = Field(
        None, description='Swell height observed'
    )
    swellPeriod: Optional[confloat(ge=0.0)] = Field(
        None, description='Swells period observed'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be WaterObserved'
    )
    ...
    waveLength: Optional[confloat(ge=0.0)] = Field(
        None, description='Wave Length observed. '
    )
