...
class Type6(Enum):
    NoiseLevelObserved = 'NoiseLevelObserved'


class NoiseLevelObserved(BaseModel):
    ...
    LAeq: Optional[float] = Field(
        None, description='The frequency weighted Leq sound level (A-weighting)'
    )
    ...
    dateObservedFrom: Optional[AwareDatetime] = Field(
        None, description='Observation period start date and time'
    )
    ...
    distanceAverage: Optional[str] = Field(
        None, description='Average distance between sensor and potential noise sources'
    )
    heightAverage: Optional[str] = Field(
        None,
    ...
    refDevice: Optional[
        ...
        None, description='A reference to the device which captured this observation'
    )
    ...
    ] = Field(None, description='Reference to the associated weather conditions')
    seeAlso: Optional[Union[List[AnyUrl], AnyUrl]] = Field(
        None, description='list of uri pointing to additional resources about the item'
    )
    sonometerClass: Optional[SonometerClass] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='NGSI Entity type')
